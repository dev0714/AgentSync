...
/**
 * Animated hero backdrop. Renders a full-bleed WebGL2 canvas; the shader and its
 * uniforms are driven from a ref so prop changes never re-create the context.
 */
export default function Aurora({
  colorStops = ['#2B2FD9', '#7C9CF5', '#F06AA8'],
  amplitude = 0.45,
  blend = 1.6,
  speed = 0.18,
}: AuroraProps) {
